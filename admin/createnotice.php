<?php include 'header.php'; ?>
    ...
    <form action="" class="mt-5">
        ...
        <input type="text" name="content" placeholder="Enter Content" class="w-full p-2 my-2 border border-gray-400 rounded-lg">
        <div class="flex mt-4 justify-center gap-4">
            <button type="submit" class="p-2 px-5 bg-blue-600 text-white rounded-lg">Add Notice</button>
